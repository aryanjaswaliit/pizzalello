...
class GUI2 extends JFrame 
{
	...
	public GUI2() 
	{
		...
		logo_name = new JLabel("Pizza Lelo", logo, 0);
		initial_panel = new JPanel();
		initial_panel.setLayout(new GridLayout(5, 1));		
		
		JOptionPane.showMessageDialog(new JFrame(), "Welcome to Pizza Lelo! ", "Pizza Lelo ", JOptionPane.PLAIN_MESSAGE, logo);
		...
		initial_panel.add(date_time);					
                ...
                logo = new ImageIcon("pizza.png");			
		create_by = new JLabel("Create By", logo, 0);		
		initial_panel.add(create_by);
		
                
                logo = new ImageIcon("pizza.png");			
		create_by = new JLabel("Aryan & Mallika Jaswal ", logo, 0);		
		initial_panel.add(create_by);
		
                logo = new ImageIcon("pizza.png");			
		create_by = new JLabel("#Opensource #pizzalelo", logo, 0);		
		initial_panel.add(create_by);
